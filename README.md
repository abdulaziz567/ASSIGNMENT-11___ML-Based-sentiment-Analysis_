...
In this project uses **Natural Language Processing (NLP)** techniques and a **Logistic Regression model** trained on the **IMDB 50K Movie Reviews Dataset** to classify user input reviews.
